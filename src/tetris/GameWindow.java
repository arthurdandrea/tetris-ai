...
public class GameWindow extends JFrame {
    ...
    /*
     * Creates a GameWindow and make it fullscreen or not. May be from another GameWindow.
     */
    ...
    public static GameWindow enterFullScreen(GameWindow win) {
        ...
        try {
            ...
            //800x600 fullscreen?
            win.dev.setDisplayMode(new DisplayMode(800, 600, 32, DisplayMode.REFRESH_RATE_UNKNOWN));
